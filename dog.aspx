<%@ Page Title="" Language="C#" MasterPageFile="~/User.Master" AutoEventWireup="true" CodeBehind="dog.aspx.cs" Inherits="PetShop.dog" %>
...
<section class="products-section">
        ...
        <div class="product-card">
            <img src="https://images.unsplash.com/photo-1601758228041-f3b2795255f1?ixlib=rb-4.0.3&amp;ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&amp;auto=format&amp;fit=crop&amp;w=500&amp;q=80" alt="French Bulldog" class="product-image">
            <div class="product-info">
                <h3 class="product-name">French Bulldog</h3>
                <p class="product-price">$1500</p>
                <button class="add-to-cart" onclick="addToCart(3, 'dogs')">
                    Add to Cart
                </button>
            </div>
        </div>
        ...
        <div class="product-card">
            <img src="https://images.unsplash.com/photo-1543466835-00a4907b8201?ixlib=rb-4.0.3&amp;ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&amp;auto=format&amp;fit=crop&amp;w=500&amp;q=80" alt="Labrador Retriever" class="product-image">
            <div class="product-info">
                <h3 class="product-name">Labrador Retriever</h3>
                <p class="product-price">$1100</p>
                <button class="add-to-cart" onclick="addToCart(4, 'dogs')">
                    Add to Cart
                </button>
            </div>
        </div>
