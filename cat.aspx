<%@ Page Title="" Language="C#" MasterPageFile="~/User.Master" AutoEventWireup="true" CodeBehind="cat.aspx.cs" Inherits="PetShop.cat" %>
...
<section class="page-header">
    <div class="container">
        <h1>Cats</h1>
        <p>Discover adorable feline friends</p>
    </div>
</section>
...
<section class="products-section">
        ...
        <div class="product-card">
            <img src="https://images.unsplash.com/photo-1574158622682-e40e69881006?ixlib=rb-4.0.3&amp;ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&amp;auto=format&amp;fit=crop&amp;w=500&amp;q=80" alt="British Shorthair" class="product-image">
            <div class="product-info">
                <h3 class="product-name">British Shorthair</h3>
                <p class="product-price">$750</p>
                <button class="add-to-cart" onclick="addToCart(7, 'cats')">
                    Add to Cart
                </button>
            </div>
        </div>
        ...
        <div class="product-card">
            <img src="https://images.unsplash.com/photo-1571566882372-1598d88abd90?ixlib=rb-4.0.3&amp;ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&amp;auto=format&amp;fit=crop&amp;w=500&amp;q=80" alt="Siamese Cat" class="product-image">
            <div class="product-info">
                <h3 class="product-name">Siamese Cat</h3>
                <p class="product-price">$700</p>
                <button class="add-to-cart" onclick="addToCart(8, 'cats')">
                    Add to Cart
                </button>
            </div>
        </div>
