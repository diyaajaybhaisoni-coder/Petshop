<%@ Page Title="" Language="C#" MasterPageFile="~/User.Master" AutoEventWireup="true" CodeBehind="dog-food.aspx.cs" Inherits="PetShop.dog_food" %>
...
<asp:Content ID="Content3" runat="server" contentplaceholderid="ContentPlaceHolder2">
    ...
    <section class="page-header">
        <div class="container">
            <h1>Dog Food</h1>
            <p>Nutritious and delicious meals for your canine companion</p>
        </div>
    </section>
...
<section class="products-section">
        ...
        <div class="product-card">
            <img src="https://images.unsplash.com/photo-1583337130417-3346a1be7dee?ixlib=rb-4.0.3&amp;ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&amp;auto=format&amp;fit=crop&amp;w=500&amp;q=80" alt="Premium Dog Food - Chicken" class="product-image">
            <div class="product-info">
                <h3 class="product-name">Premium Dog Food - Chicken</h3>
                <p class="product-price">$45</p>
                <button class="add-to-cart" onclick="addToCart(9, 'dogFood')">
                    Add to Cart
                </button>
            </div>
        </div>
        ...
        <div class="product-card">
            <img src="https://images.unsplash.com/photo-1601758228041-f3b2795255f1?ixlib=rb-4.0.3&amp;ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&amp;auto=format&amp;fit=crop&amp;w=500&amp;q=80" alt="Grain-Free Dog Food" class="product-image">
            <div class="product-info">
                <h3 class="product-name">Grain-Free Dog Food</h3>
                <p class="product-price">$55</p>
                <button class="add-to-cart" onclick="addToCart(10, 'dogFood')">
                    Add to Cart
                </button>
            </div>
        </div>
        ...
        <div class="product-card">
            <img src="https://images.unsplash.com/photo-1552053831-71594a27632d?ixlib=rb-4.0.3&amp;ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&amp;auto=format&amp;fit=crop&amp;w=500&amp;q=80" alt="Puppy Formula" class="product-image">
            <div class="product-info">
                <h3 class="product-name">Puppy Formula</h3>
                <p class="product-price">$35</p>
                <button class="add-to-cart" onclick="addToCart(11, 'dogFood')">
                    Add to Cart
                </button>
            </div>
        </div>
        ...
        <div class="product-card">
            <img src="https://images.unsplash.com/photo-1543466835-00a4907b8201?ixlib=rb-4.0.3&amp;ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&amp;auto=format&amp;fit=crop&amp;w=500&amp;q=80" alt="Senior Dog Food" class="product-image">
            <div class="product-info">
                <h3 class="product-name">Senior Dog Food</h3>
                <p class="product-price">$50</p>
                <button class="add-to-cart" onclick="addToCart(12, 'dogFood')">
                    Add to Cart
                </button>
            </div>
        </div>
