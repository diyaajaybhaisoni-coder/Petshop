        ...
        <nav class="navbar">
            <div class="nav-container">
                ...
                <div class="nav-actions">
                    <a href="cart.aspx" class="cart-btn"><i class="fas fa-shopping-cart"></i><span class="cart-count">0</span> </a>
                    <%--<a href="admin/login.aspx" class="admin-btn" style="background: #2c3e50; color: white; padding: 8px 16px; border-radius: 25px; text-decoration: none; font-weight: 500; transition: all 0.3s ease;"><i class="fas fa-shield-alt"></i>Admin </a>--%>
                        <a href="login.aspx" class="login-btn">Login</a> <a href="register.aspx" class="register-btn">Register</a>
                </div>
                <div class="hamburger">
...
<div style="text-align: center; padding: 50px;">
                ...
                <a href="Uindex.aspx" class="btn btn-primary">Continue Shopping</a>
            </div>    
        <asp:GridView runat="server" AutoGenerateColumns="False" CssClass="admin-table" 
             ...
             <Columns>
               ...
               <%-- <asp:TemplateField HeaderText="ID" ItemStyle-Width="80" ItemStyle-HorizontalAlign="Center">
                     <ItemTemplate>
                         <asp:Label ID="Label4" runat="server" Text='<%# Eval("Id") %>' CssClass="cart-id"></asp:Label>
                     </ItemTemplate>
</asp:TemplateField>--%>
    </div>
</section>
